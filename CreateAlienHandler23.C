AliAnalysisGrid* CreateAlienHandler23()
{
...
/*============================================================================*/  
  plugin->SetRunMode("full");
   ...
   char per[1]="g"; // g, h, i, j, k, l, o, p

/*============================================================================*/  

// Set versions of used packages
   plugin->SetAPIVersion("V1.1x");
   plugin->SetAliPhysicsVersion("vAN-20171226-1");

// Declare input data to be processed.
// Method 1: Create automatically XML collections using alien 'find' command.

// Define production directory LFN
   plugin->SetGridDataDir(Form("/alice/data/2016/LHC16%s",per));
   plugin->SetGridWorkingDir(Form("pp_Analysis/LHC16%s",per));
...
// Declare alien output directory. Relative to working directory.
   plugin->SetGridOutputDir("pass1"); // In this case will be $HOME/work/output
...
// loaded by the generated analysis macro. Add all extra files (task .cxx/.h) here.
   plugin->SetAdditionalLibs("AliAnalysisTaskGamma_aod.h AliAnalysisTaskGamma_aod.cxx AliCaloPhoton.h AliCaloPhoton.cxx  libTender.so libTenderSupplies.so libPWGGAPHOSTasks.so CreatePHOSTender.C");
