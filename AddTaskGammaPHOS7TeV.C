...
AliAnalysisTaskGammaPHOS7TeV* AddTaskGammaPHOS7TeV( Bool_t isMC,
                                                    TString name = "name")
{
  ...
  //  TString fileName = AliAnalysisManager::GetCommonFileName();
    ...
    //TString fileName2 = "PtMC.AOD.2.root";
    //fileName += ":MyTask";      // create a subfolder in the file
    // now we create an instance of your task
    AliAnalysisTaskGammaPHOS7TeV* task = new AliAnalysisTaskGammaPHOS7TeV(name.Data());   
    if(!task) return 0x0;
